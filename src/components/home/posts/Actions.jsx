...
const Actions = ({fav,comment,retweet,etkilesim}) => {

  const[liked,setLiked] = useState(false)
  console.log(liked)
const onLike=(e)=>{
  if(liked===false){setLiked(fav + 1)}
  else{setLiked(false)}
}
